...
Why is it only available for Jupyter Notebook? We selected the environment as this provides excellent visual and interaction tools, enabling interactive exploration of cellular automation. However we are exploring command line support to enable a user wider access and flexibility for usage with more general executables as well.. 

Where should I start with the code for contribution and modifications? Start within  visualization code as well as rules implementation and helper tools for a quick and efficient way into this system and code.   We're looking for improvements there in particular, to extend functionality, to improve visuals or expand rules support

How often do I have to refresh PyChess to incorporate updates in the next versions. It may depend if a user wants to run in an active state or as is and is able to wait on updates and future development.
...
We encourage citations and acknowledgements to help others explore and discover PyChess.

Here are examples to refer it to publications (may update) and also the citation style may also depend and adapt as needed based on publications and contexts

```  text 	# Using BiBeTX formatted reference. Update as applicable to journal and publications
 @misc{PyChess,
 	author = {Organization},
 	title = {PyChess, a python visual cellular automation analyser },
 	year = {2024},
 	publisher = {GitHub},
 	url = {https://github.com/Organization/PyChess},
 	note = {Accessed: Date},
 } 
 ```

The framework' open availability encourages exploration in various contexts with an open source approach to collaboration for a benefit of the science.   



## Contact

Please contact the PyChess developer through a GitHub email or directly through community support channel if you require immediate response for any problems, issues or feedback. We value any form of support from community. Please submit issues on a tracker.
