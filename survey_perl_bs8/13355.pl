...
# 14. Interactive menu
#   interactive_menu(); # Ensure it runs interactively. User experience

# 15 Log and Reporting 
#     report_log(); # Report everything. Ensure reporting is complete, accurate and reliable
  
# 16, #cross compiler - define compiler for other systems, ensure the compiler builds on another OS system.  Define all build architecture options. Define OS options and build targets, must work
  #Cross compile the build

#17, Recovery
#    restore_build(); 

#Summary report and status

  
exit 0;  # Indicate complete successful operation to caller of function 
