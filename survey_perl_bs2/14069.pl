...
#  The logging must be verbose
  ...
  For portability, a full configuration needs per platforms with different architectures, libraries. (versions). This is a very important step

For portability and full automation.
